...
export const RESTAURANTS = [{
	...
	"paragraph": {
		...
		"two": "Wanting to try a Canadian beer, not the kind you\"d find stacked with the Bud and Coors of the world, I opted for a Hoyne Pilsner, from a local craft brewery, to have something different.  A crisp summer beer seemed perfect for the type of weather outside.  Though the glass was frozen, the beer itself had a nice refreshing taste.  Sticking to wanting to have something different, I had a bowl of Chowder, which was presented nicely and tasted well also.",
